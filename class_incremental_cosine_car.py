...
# @Author : Jiaqi Guo
# @Site : 
# @File : class_incremental_cosine_car.py
# @Software: PyCharm
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='seed_1993_subset_98_Car', type=str)
    parser.add_argument('--datadir', default='data/seed_1993_subset_100_imagenet/data', type=str)
    parser.add_argument('--saved_dir', default='CAR196_resnet50_Cosine', type=str)
    parser.add_argument('--num_classes', default=196, type=int)
    parser.add_argument('--num_workers', default=0, type=int, \
        help='the number of workers for loading data')
    parser.add_argument('--nb_cl_fg', default=98, type=int, \
        help='the number of classes in first group')
    parser.add_argument('--nb_cl', default=14, type=int, \
    ...
    trainset = datasets.standford_cars(root='C:/zhaozy/datasets/FGVC/CAR-196', is_training=True)
    testset = datasets.standford_cars(root='C:/zhaozy/datasets/FGVC/CAR-196', is_training=False)
    evalset = datasets.standford_cars(root='C:/zhaozy/datasets/FGVC/CAR-196', is_training=False)
