...
# @Author : Jiaqi Guo
# @Site : 
# @File : class_incremental_cosine_air.py
# @Software: PyCharm
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='seed_1993_subset_35_AirFamily', type=str)
    parser.add_argument('--datadir', default='data/seed_1993_subset_100_imagenet/data', type=str)
    parser.add_argument('--saved_dir', default='AirFamily70_resnet50_Cosine', type=str)
    parser.add_argument('--num_classes', default=70, type=int)
    parser.add_argument('--num_workers', default=0, type=int, \
        help='the number of workers for loading data')
    parser.add_argument('--nb_cl_fg', default=35, type=int, \
    ...
    trainset = datasets.fgvc_air_family(root='C:/zhaozy/datasets/FGVC/fgvc-aircraft-2013b/data', is_training=True, data_len=None)
    testset = datasets.fgvc_air_family(root='C:/zhaozy/datasets/FGVC/fgvc-aircraft-2013b/data', is_training=False, data_len=None)
    evalset = datasets.fgvc_air_family(root='C:/zhaozy/datasets/FGVC/fgvc-aircraft-2013b/data', is_training=False, data_len=None)
    ...
    for iteration_total in range(args.nb_runs):
        ...
        for iteration in range(start_iter, int(args.num_classes/args.nb_cl)):
            ...
            if iteration == start_iter:
                ...
                last_iter = 0
                ############################################################
                tg_model = models.resnet50(pretrained=True)
                tg_model.fc = nn.Linear(2048, args.nb_cl_fg)
